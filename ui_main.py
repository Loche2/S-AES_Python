...
"")
        ...
        self.lineEdit_Key.setMinimumSize(QtCore.QSize(200, 33))
...
from qfluentwidgets import ComboBox, LineEdit, PlainTextEdit, PrimaryPushButton, PushButton, RadioButton, StrongBodyLabel, ToolButton
